...
abstract class TraitGenerator implements Consumer<GenerateTraitDirective> {
    ...
    protected abstract void writeAdditionalMethods(TraitCodegenWriter writer, GenerateTraitDirective directive);
    protected abstract void writeBuilder(TraitCodegenWriter writer, GenerateTraitDirective directive);
}
